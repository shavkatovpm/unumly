...
/** Qotib turadigan yuqori qism: sarlavha + balans + oylik byudjet */
...
/** Scroll bo'ladigan pastki qism: toifalar + so'nggi amallar */
export function FinanceBody() {
  ...
  return (
    <div className="space-y-4 px-4 pb-4 pt-4 sm:px-5 sm:pb-5">
      {/* Toifalar bo'yicha */}
      <div className="rounded-lg border border-border bg-surface px-4 py-3 shadow-[0_1px_0_var(--border)]">
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    item.positive ? "font-medium text-accent" : "text-foreground"
                  )}
                >
                  {item.amount}
                </span>
