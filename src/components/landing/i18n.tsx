...
const uz = {
  ...
  ctaSec: {
    eyebrow: "Hoziroq boshlang",
    title: "Bugundan boshlang",
    sub: "Roʻyxatdan oʻtish yoki karta shart emas — shunchaki oching va boshlang.",
    cta: "Boshlash",
    note: "Bepul · Reklama yoʻq · Qurilmangizda",
  },
  bugun: {
    header: "Bugun",
...
const en: Translation = {
  ...
  ctaSec: {
    eyebrow: "Start now",
    title: "A productive day starts today",
    sub: "No sign-up or card required — just open it and go.",
    cta: "Get started",
    note: "Free · No ads · Stored on your device",
  },
  bugun: {
    header: "Today",
    date: "June 18, Wed",
...
const ru: Translation = {
  ...
  ctaSec: {
    ...
    title: "Продуктивный день начинается сегодня",
    sub: "Регистрация и карта не нужны — просто откройте и начните.",
    cta: "Начать",
    note: "Бесплатно · Без рекламы · На вашем устройстве",
  },
  bugun: {
    header: "Сегодня",
    date: "18 июня, ср",
